...
def build_pdf():
    ...
    story.append(
        Paragraph(
            "Silent-recording pacing guide with exact hold times per action for post-recording voiceover sync.",
            sub_style,
        )
    )
    ...
    checklist_data = [
        [
            Paragraph(
                "<b>4-MINUTE RECORDING GUIDE (MATCHING YOUR SCREEN RECORDING):</b><br/>"
                ...
                "• Total video runtime: <b>~4 minutes 10 seconds</b> (250 seconds).",
                checklist_style,
            )
        ]
    ]
